    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$appoint->created_at->format('d-m-Y')}}</td>
                <td>{{$appoint->message}}</td>
                <td>{{$appoint->status}}</td>
                <td><a href="{{url('cancel-appointment', $appoint->id)}}" onclick="return confirm('are you sure want to delete this?')" class="btn btn-danger">Cancel</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
